...
import { CedulaParamDto, CorreoDto, DireccionDto, DpiParamDto, IgssParamDto, IrtraParamDto, NitParamDto, NombreApellidoDto, NombreCompletoDto, PasaporteParamDto, PhoneNumberDto, PrimerApellidoSegundoApellidoDto, TrabajoDto } from './dto';
...
export declare class BusquedaController {
    ...
    getByCorreo(params: CorreoDto): Promise<import("../schemas/Persona").Persona | null>;
